...
// /gb/guides and /au/guides are both English. Declare the full BCP-47 tag so each post
// says which market it is written for, not just which language. Everything else is en-GB.
